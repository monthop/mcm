...
<?php
 ...
 function okForm() {
    //echo "goto data form";
	header("Location: /bsdisplayPlan.php");
}
...
$sql = "UPDATE mcmonitoring.plandata SET Sequence = $newSequence,PlannedQty = $newQty WHERE ID = $ID;";
...
?>
<div class='container'>
	<a href="/bssequence.php" class="btn btn-info" role="button">Go Back</a>
</div>
