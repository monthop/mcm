...
$sql = "INSERT INTO mcmonitoring.plandata (ID,timestamp,McNo,LotNo,PlannedQty,ItemNo,Status,ProducedQty,Sequence,AvTime,CycleTime)
VALUES (NULL,CURRENT_TIMESTAMP,$McNoStr,$LotNoStr,'','','0','','1','','');";
