...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Data for MC-003</h2>
	  ...
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bspostmysql2-003.php">  
	...
	<a href="bsdeleteData3.php" class="btn btn-warning" role="button">Delete Record</a>	 
