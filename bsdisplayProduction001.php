...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Data for MC-001</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$PlannedQty = $Status = $StartDateTime = $RunDateTime = $StopDateTime = $ProducedQty = $BreakTime = "";
	...
	<a href="/bsdeleteData1.php" class="btn btn-warning" role="button">Delete Record</a>
