...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Plan for All Machines</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$sql = "SELECT * FROM mcmonitoring.plandata ORDER BY McNo,ID;";
	...
	<a href="/bssequence.php" class="btn btn-warning" role="button">Edit Sequence</a>
	<a href="/bsdeleteSelect.php" class="btn btn-success" role="button">Delete Record</a>
