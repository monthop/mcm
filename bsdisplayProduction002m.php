...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Data for MC-002 m</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$sql = "SELECT * FROM mcmonitoring2.productiondata WHERE McNo = 'MC-002' ORDER BY ID DESC;";
	...
	<!-- The Modal -->
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bspostmysql2-002m.php">  
	  ...
	  <a href="/bsdeleteData2m.php" class="btn btn-warning" role="button">Delete Record m</a>
