...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Data for MC-002</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$PlannedQty = $Status = $StartDateTime = $RunDateTime = $StopDateTime = $ProducedQty = $BreakDateTime = "";
							$AQty = $AvTime = $CycleTime = $TotalDefect = "";

							$sql = "SELECT * FROM mcmonitoring.productiondata WHERE McNo = 'MC-002' ORDER BY ID DESC;";
	...
	<!-- The Modal -->
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bspostmysql2-002.php">  
	  ...
	  <a href="/bsdeleteData2.php" class="btn btn-warning" role="button">Delete Record</a>
