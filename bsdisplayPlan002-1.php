...
.tableFixHead th {
  ...
  background: #eee;
	  ...
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bsinsertPlandata002.php">  
	...
	<a href="/bssequence2.php" class="btn btn-warning" role="button">Edit Sequence</a>
	<a href="/bsdeleteSelect2.php" class="btn btn-success" role="button">Delete Record</a>
