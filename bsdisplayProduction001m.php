...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Data for MC-001 m</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$sql = "SELECT * FROM mcmonitoring2.productiondata WHERE McNo = 'MC-001' ORDER BY ID DESC;";
	  ...
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bspostmysql2-001m.php">  
			...
			<div class="modal-footer">
			  <button type="button" class="btn btn-danger" data-dismiss="modal">Close m</button>
			</div>
			</div>
		</div>
	  </div>
	<a href="/bsdeleteData1m.php" class="btn btn-warning" role="button">Delete Record m</a>
	<a href="/bseditorm.php" class="btn btn-info" role="button">Go Back m</a>	
	</div>
	<br>
</body>
</html>
