...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Data for MC-003 m</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$sql = "SELECT * FROM mcmonitoring2.productiondata WHERE McNo = 'MC-003' ORDER BY ID DESC;";
	  ...
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bspostmysql2-003m.php">  
	...
	<a href="bsdeleteData3m.php" class="btn btn-warning" role="button">Delete Record m</a>	 
