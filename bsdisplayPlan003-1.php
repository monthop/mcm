...
<div class='container'>
	  ...
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bsinsertPlandata003.php">  
	...
	<a href="/bssequence3.php" class="btn btn-warning" role="button">Edit Sequence</a>
	<a href="/bsdeleteSelect3.php" class="btn btn-success" role="button">Delete Record</a>
