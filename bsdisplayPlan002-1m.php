...
.tableFixHead th {
  ...
  background: #eee;
	...
	<div class='container'>
		<h2 style="color:Tomato;">Production Plan for MC-002</h2>
				...
				<div class='table-responsive'>
					...
					<table border='1' class='table table-hover table-inverse table-bordered table-sm '>  
						...
						<tbody>
							...
							$sql = "SELECT * FROM mcmonitoring.plandata WHERE McNo = 'MC-002' ORDER BY ID DESC;";
	  ...
	  <div class="modal" id="myModal">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<form method="post" action="bsinsertPlandata002m.php">  
	...
	<a href="/bssequence2m.php" class="btn btn-warning" role="button">Edit Sequence</a>
	<a href="/bsdeleteSelect2m.php" class="btn btn-success" role="button">Delete Record</a>
